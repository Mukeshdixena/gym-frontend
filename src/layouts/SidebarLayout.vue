  ...
  <div class="d-flex min-vh-100">
    ...
    <aside class="bg-dark text-light py-4 px-2" style="width: 220px; position: relative;">
      ...
      <nav class="nav flex-column">
        ...
        <router-link to="/assign-membership-plan" class="nav-link text-light" active-class="active">Assign Membership
          Plan</router-link>
      ...
      <div class="mt-auto pt-3">
        <button @click="logout" class="btn btn-outline-light w-100" title="Clear local storage and log out">
          Logout
        </button>
      </div>
    </aside>
