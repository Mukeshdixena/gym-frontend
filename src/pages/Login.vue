  ...
  <div class="container-fluid min-vh-100 d-flex align-items-center justify-content-center bg-light">
    ...
    <div class="card shadow-lg" style="max-width: 420px; width: 100%">
      ...
      <div class="card-body p-4">
          ...
          <div class="tab-pane fade show active" id="login">
            <form @submit.prevent="loginUser">
              <div class="mb-3">
                ...
                <input id="loginEmail" v-model="loginForm.email" type="email" class="form-control"
                  placeholder="admin@gym.com" required :disabled="isLoading" />
              </div>
              <div class="mb-3">
          ...
          <div class="tab-pane fade" id="signup">
            <form @submit.prevent="signupUser">
              <div class="mb-3">
                ...
                <input id="signupName" v-model="signupForm.name" type="text" class="form-control" placeholder="John Doe"
                  required :disabled="isLoading" />
              </div>
              <div class="mb-3">
                <label for="signupEmail" class="form-label">Email</label>
                <input id="signupEmail" v-model="signupForm.email" type="email" class="form-control"
                  placeholder="john@example.com" required :disabled="isLoading" />
              </div>
              <div class="mb-3">
                <label for="signupPassword" class="form-label">Password</label>
                <div class="input-group">
                  <input id="signupPassword" v-model="signupForm.password"
                    :type="showSignupPassword ? 'text' : 'password'" class="form-control"
                    placeholder="Min. 6 characters" required minlength="6" :disabled="isLoading" />
                  <button type="button" class="btn btn-outline-secondary"
                    @click="showSignupPassword = !showSignupPassword" :disabled="isLoading">
        ...
        <!-- Error -->
        <div v-if="serverError" class="alert alert-danger mt-3 py-2 text-center small">
          {{ serverError }}
        </div>
        ...
        <div class="text-center mt-4">
          <small class="text-muted">
            Need help? <a href="mailto:admin@gym.com" class="text-primary">Contact Admin</a>
          </small>
        </div>
      </div>
    </div>
...
const toastMessage = ref('')   // ← already defined
...
const loginUser = async () => {
  ...
  try {
    ...
    serverError.value = err.response?.data?.message || 'Invalid credentials.'
