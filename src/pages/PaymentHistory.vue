              ...
              <tr>
                  ...
                  <div class="filter-wrapper">
                    ...
                    <transition name="fade-slide">
                      <input v-if="columnFilters.amount" v-model.trim="filters.amount"
                        ...
                        placeholder="e.g. 500" @blur="handleBlur('amount')" />
                    </transition>
                ...
                <th class="filter-header">
                  <div class="filter-wrapper">
                    ...
                    <button class="filter-btn" :class="{ active: columnFilters.method }"
                      @click.stop="toggleFilter('method')" title="Filter Method">
                ...
                <th class="filter-header">
                  <div class="filter-wrapper">
                    ...
                    <button class="filter-btn" :class="{ active: columnFilters.type }"
                      @click.stop="toggleFilter('type')" title="Filter Type">
                            ...
                            <div class="d-flex align-items-center">
                              <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                  viewBox="0 0 16 16">
                                  <path
                                    d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L10.293 7.5H4.5z" />
                                </svg>
                              </div>
                              <div>
                            ...
                            <div class="d-flex align-items-center">
                              <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                  viewBox="0 0 16 16">
                                  <path
                                    d="M8.5 2.687c.654-.689 1.782-.886 3.112-.752 1.234.124 2.502.394 3.512.844l.5.25a.5.5 0 0 1 0 .866l-2.5 1.25a.5.5 0 0 1-.5 0l-2.5-1.25a.5.5 0 0 1 0-.866l.5-.25c.51-.25 1.18-.52 1.876-.752zM8.5 8.687c.654-.689 1.782-.886 3.112-.752 1.234.124 2.502.394 3.512.844l.5.25a.5.5 0 0 1 0 .866l-2.5 1.25a.5.5 0 0 1-.5 0l-2.5-1.25a.5.5 0 0 1 0-.866l.5-.25c.51-.25 1.18-.52 1.876-.752z" />
                                </svg>
                              </div>
                              <div>
